...
describe('deltaE', () => {
  ...
  describe('dE00', () => {
    ...
    it('0.0 difference', () => {
      ...
      assertDeltaE00(0.0, [99.5, 0.005, -0.01], [99.5, 0.005, -0.01])
    })
    it('100.0 difference', () => {
      assertDeltaE00(100.0, [100, 0.005, -0.01], [0.0, 0.0, 0.0])
    })
    it('True chroma difference (#1)', () => {
      assertDeltaE00(2.0425, [50.0, 2.6772, -79.7751], [50.0, 0.0, -82.7485])
    })
    it('True chroma difference (#2)', () => {
      assertDeltaE00(2.8615, [50.0, 3.1571, -77.2803], [50.0, 0.0, -82.7485])
    })
    it('True chroma difference (#3)', () => {
      assertDeltaE00(3.4412, [50.0, 2.8361, -74.02], [50.0, 0.0, -82.7485])
    })
    it('True hue difference (#4)', () => {
      assertDeltaE00(1.0, [50.0, -1.3802, -84.2814], [50.0, 0.0, -82.7485])
    })
    it('True hue difference (#5)', () => {
      assertDeltaE00(1.0, [50.0, -1.1848, -84.8006], [50.0, 0.0, -82.7485])
    })
    it('True hue difference (#6)', () => {
      assertDeltaE00(1.0, [50.0, -0.9009, -85.5211], [50.0, 0.0, -82.7485])
    })
    it('Arctangent computation (#7)', () => {
      assertDeltaE00(2.3669, [50.0, 0.0, 0.0], [50.0, -1.0, 2.0])
    })
    it('Arctangent computation (#8)', () => {
      assertDeltaE00(2.3669, [50.0, -1.0, 2.0], [50.0, 0.0, 0.0])
    })
    it('Arctangent computation (#9)', () => {
      assertDeltaE00(7.1792, [50.0, 2.49, -0.001], [50.0, -2.49, 0.0009])
    })
    it('Arctangent computation (#10)', () => {
      assertDeltaE00(7.1792, [50.0, 2.49, -0.001], [50.0, -2.49, 0.001])
    })
    it('Arctangent computation (#11)', () => {
      assertDeltaE00(7.2195, [50.0, 2.49, -0.001], [50.0, -2.49, 0.0011])
    })
    it('Arctangent computation (#12)', () => {
      assertDeltaE00(7.2195, [50.0, 2.49, -0.001], [50.0, -2.49, 0.0012])
    })
    it('Arctangent computation (#13)', () => {
      assertDeltaE00(4.8045, [50.0, -0.001, 2.49], [50.0, 0.0009, -2.49])
    })
    it('Arctangent computation (#14)', () => {
      assertDeltaE00(4.8045, [50.0, -0.001, 2.49], [50.0, 0.001, -2.49])
    })
    it('Arctangent computation (#15)', () => {
      assertDeltaE00(4.7461, [50.0, -0.001, 2.49], [50.0, 0.0011, -2.49])
    })
    it('Arctangent computation (#16)', () => {
      assertDeltaE00(4.3065, [50.0, 2.5, 0.0], [50.0, 0.0, -2.5])
    })
    it('Large color differences (#17)', () => {
      assertDeltaE00(27.1492, [50.0, 2.5, 0.0], [73.0, 25.0, -18.0])
    })
    it('Large color differences (#18)', () => {
      assertDeltaE00(22.8977, [50.0, 2.5, 0.0], [61.0, -5.0, 29.0])
    })
    it('Large color differences (#19)', () => {
      assertDeltaE00(31.903, [50.0, 2.5, 0.0], [56.0, -27.0, -3.0])
    })
    it('Large color differences (#20)', () => {
      assertDeltaE00(19.4535, [50.0, 2.5, 0.0], [58.0, 24.0, 15.0])
    })
    it('CIE technical report (#21)', () => {
      assertDeltaE00(1.0, [50.0, 2.5, 0.0], [50.0, 3.1736, 0.5854])
    })
    it('CIE technical report (#22)', () => {
      assertDeltaE00(1.0, [50.0, 2.5, 0.0], [50.0, 3.2972, 0.0])
    })
    it('CIE technical report (#23)', () => {
      assertDeltaE00(1.0, [50.0, 2.5, 0.0], [50.0, 1.8634, 0.5757])
    })
    it('CIE technical report (#24)', () => {
      assertDeltaE00(1.0, [50.0, 2.5, 0.0], [50.0, 3.2592, 0.335])
    })
    it('CIE technical report (#25)', () => {
      assertDeltaE00(1.2644, [60.2574, -34.0099, 36.2677], [60.4626, -34.1751, 39.4387])
    })
    it('CIE technical report (#26)', () => {
      assertDeltaE00(1.263, [63.0109, -31.0961, -5.8663], [62.8187, -29.7946, -4.0864])
    })
    it('CIE technical report (#27)', () => {
      assertDeltaE00(1.8731, [61.2901, 3.7196, -5.3901], [61.4292, 2.248, -4.962])
    })
    it('CIE technical report (#28)', () => {
      assertDeltaE00(1.8645, [35.0831, -44.1164, 3.7933], [35.0232, -40.0716, 1.5901])
    })
    it('CIE technical report (#29)', () => {
      assertDeltaE00(2.0373, [22.7233, 20.0904, -46.694], [23.0331, 14.973, -42.5619])
    })
    it('CIE technical report (#30)', () => {
      assertDeltaE00(1.4146, [36.4612, 47.858, 18.3852], [36.2715, 50.5065, 21.2231])
    })
    it('CIE technical report (#31)', () => {
      assertDeltaE00(1.4441, [90.8027, -2.0831, 1.441], [91.1528, -1.6435, 0.0447])
    })
    ...
    it('CIE technical report (#34)', () => {
      assertDeltaE00(0.9082, [2.0776, 0.0795, -1.135], [0.9033, -0.0636, -0.5514])
    })
  })
})
