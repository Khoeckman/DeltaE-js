...
export function getDeltaE_CMC([L1, a1, b1]: LAB, [L2, a2, b2]: LAB, weights: CMC = {}): number {
  ...
  const h1 = atan2(b1, a1) * RAD2DEG

  // hue rotation term
  const T =
    h1 >= 164 && h1 <= 345 ? 0.56 + abs(0.2 * cos((h1 + 168) * DEG2RAD)) : 0.36 + abs(0.4 * cos((h1 + 35) * DEG2RAD))
 ...
 *
 * Power optimization research by Khoeckman (2026):
 * https://jsbm.dev/GdQ0D4VWQEUYg r^7 (most relevant)
 * https://jsbm.dev/ALU0UILdW3rpX r^16
 * https://jsbm.dev/ERctFijKZSuaa r^31
 */
